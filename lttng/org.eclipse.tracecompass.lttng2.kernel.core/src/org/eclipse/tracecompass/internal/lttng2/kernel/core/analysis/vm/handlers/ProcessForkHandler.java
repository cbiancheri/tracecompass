...
public class ProcessForkHandler extends VMKernelEventHandler {

    public ProcessForkHandler(IKernelAnalysisEventLayout layout, FusedVirtualMachineStateProvider sp) {
        super(layout, sp);
    }
